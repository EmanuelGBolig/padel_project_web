# Generated by Django 5.2.16 on 2026-08-13 04:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0022_customuser_debe_cambiar_password'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-creada'],
                'indexes': [models.Index(fields=['usuario', 'leida'], name='notif_usuario_leida_idx')],
            },
        ),
    ]
